...
//    public static String input_path = "C:\\Users\\musta\\Desktop\\Hacettepe\\DREAM\\final networks\\bag-nips\\out.bag-nips";
//    public static String input_path = "C:\\Users\\musta\\Desktop\\Hacettepe\\DREAM\\final networks\\amazon-ratings\\out.amazon-ratings";
        public static String input_path = "C:\\Users\\musta\\Desktop\\Hacettepe\\DREAM\\final networks\\komarix-citeseer\\out.komarix-citeseer"; // tab
//    public static String input_path = "C:\\Users\\musta\\Desktop\\Hacettepe\\DREAM\\final networks\\edit-jawiki\\out.edit-jawiki"; // tab
//    public static String input_path = "C:\\Users\\musta\\Desktop\\Hacettepe\\DREAM\\final networks\\livejournal-groupmemberships\\out.livejournal-groupmemberships"; // space
    ...
    public static void toPGD(){
        ...
        try {
            ...
            FileWriter myWriter = new FileWriter(output_path);
            myWriter.write(graph.map.size() + " " + graph.map.size() + " " + graph.edge_list.size() + "\n");
            for(int i = 0; i < graph.edge_list.size() - 1; i++){
                ArrayList<Integer> edge = graph.edge_list.get(i);
                myWriter.write(map_to_motivo.get(edge.get(0)) + " " + map_to_motivo.get(edge.get(1)) + "\n");
            }
